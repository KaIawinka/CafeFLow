      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-5 border-t border-white/10 pt-6 text-sm text-white/40 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            <a aria-label="WhatsApp" href="https://wa.me/996555000000" className="flex h-9 w-9 items-center justify-center rounded-md border border-[#25d366]/40 text-[#25d366] transition hover:border-[#25d366] hover:bg-[#25d366] hover:text-white"><WhatsAppMark /></a>
            <a aria-label="Instagram" href="https://instagram.com" className="flex h-9 w-9 items-center justify-center rounded-md border border-[#e4405f]/40 text-[#e4405f] transition hover:border-[#e4405f] hover:bg-[#e4405f] hover:text-white"><InstagramMark /></a>
            <a aria-label="Telegram" href="https://t.me" className="flex h-9 w-9 items-center justify-center rounded-md border border-[#229ed9]/40 text-[#229ed9] transition hover:border-[#229ed9] hover:bg-[#229ed9] hover:text-white"><TelegramMark /></a>
            <a aria-label="Facebook" href="https://facebook.com" className="flex h-9 w-9 items-center justify-center rounded-md border border-[#1877f2]/40 text-[#1877f2] transition hover:border-[#1877f2] hover:bg-[#1877f2] hover:text-white"><FacebookMark /></a>
            <a aria-label="Threads" href="https://threads.net" className="flex h-9 w-9 items-center justify-center rounded-md border border-white/30 text-white/75 transition hover:border-white hover:bg-white hover:text-[#151a1e]"><ThreadsMark /></a>
            <a aria-label="TikTok" href="https://tiktok.com" className="flex h-9 w-9 items-center justify-center rounded-md border border-[#ff0050]/40 text-[#ff0050] transition hover:border-[#ff0050] hover:bg-[#ff0050] hover:text-white"><TikTokMark /></a>
            <a aria-label="X" href="https://x.com" className="flex h-9 w-9 items-center justify-center rounded-md border border-white/30 text-white/75 transition hover:border-white hover:bg-white hover:text-[#151a1e]"><XMark /></a>
            <a aria-label="YouTube" href="https://youtube.com" className="flex h-9 w-9 items-center justify-center rounded-md border border-[#ff0000]/40 text-[#ff0000] transition hover:border-[#ff0000] hover:bg-[#ff0000] hover:text-white"><YouTubeMark /></a>
          </div>
        </div>
      </div>
    </footer>
