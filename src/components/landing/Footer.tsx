    ...
    <footer id="contact" className="footer-surface relative bg-[#151a1e] py-10 text-white sm:py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-5 border-t border-white/10 pt-6 text-sm text-white/40 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="cafeflow-social-card"><div className="cafeflow-social-card__background" /><a aria-label="WhatsApp" href="https://wa.me/996555000000" className="cafeflow-social-card__logo text-[#25d366]"><WhatsAppMark /></a><div className="cafeflow-social-card__box cafeflow-social-card__box--one"><a aria-label="Instagram" href="https://instagram.com" className="cafeflow-social-card__link text-[#e4405f]"><InstagramMark /></a></div><div className="cafeflow-social-card__box cafeflow-social-card__box--two"><a aria-label="Facebook" href="https://facebook.com" className="cafeflow-social-card__link text-[#1877f2]"><FacebookMark /></a></div><div className="cafeflow-social-card__box cafeflow-social-card__box--three"><a aria-label="Threads" href="https://threads.net" className="cafeflow-social-card__link text-white/75"><ThreadsMark /></a></div><div className="cafeflow-social-card__box cafeflow-social-card__box--four"><a aria-label="TikTok" href="https://tiktok.com" className="cafeflow-social-card__link text-[#ff0050]"><TikTokMark /></a></div><div className="cafeflow-social-card__box cafeflow-social-card__box--five"><a aria-label="X" href="https://x.com" className="cafeflow-social-card__link text-white/75"><XMark /></a></div><div className="cafeflow-social-card__box cafeflow-social-card__box--six"><a aria-label="Telegram" href="https://t.me" className="cafeflow-social-card__link text-[#229ed9]"><TelegramMark /></a></div><div className="cafeflow-social-card__box cafeflow-social-card__box--seven"><a aria-label="YouTube" href="https://youtube.com" className="cafeflow-social-card__link text-[#ff0000]"><YouTubeMark /></a></div></div>
        </div>
      </div>
    </footer>
  );
